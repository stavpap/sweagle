...
import com.syntax.sweagleapi.db.performance_schema.enums.ReplicationApplierGlobalFiltersConfiguredBy;
import com.syntax.sweagleapi.db.performance_schema.tables.records.ReplicationApplierGlobalFiltersRecord;
...
public class ReplicationApplierGlobalFilters extends TableImpl<ReplicationApplierGlobalFiltersRecord> {
    ...
    private static final long serialVersionUID = 960773887;
     ...
     */
    public final TableField<ReplicationApplierGlobalFiltersRecord, ReplicationApplierGlobalFiltersConfiguredBy> CONFIGURED_BY = createField("CONFIGURED_BY", org.jooq.impl.SQLDataType.VARCHAR(25).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.ReplicationApplierGlobalFiltersConfiguredBy.class), this, "");

    /**
     * The column <code>performance_schema.replication_applier_global_filters.ACTIVE_SINCE</code>.
     */
    public final TableField<ReplicationApplierGlobalFiltersRecord, Timestamp> ACTIVE_SINCE = createField("ACTIVE_SINCE", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00.000000", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
