...
import com.syntax.sweagleapi.db.performance_schema.enums.EventsTransactionsHistoryAccessMode;
import com.syntax.sweagleapi.db.performance_schema.enums.EventsTransactionsHistoryAutocommit;
import com.syntax.sweagleapi.db.performance_schema.enums.EventsTransactionsHistoryNestingEventType;
import com.syntax.sweagleapi.db.performance_schema.enums.EventsTransactionsHistoryState;
...
public class EventsTransactionsHistory extends TableImpl<EventsTransactionsHistoryRecord> {
    ...
    private static final long serialVersionUID = -682463368;
     ...
     */
    public final TableField<EventsTransactionsHistoryRecord, EventsTransactionsHistoryState> STATE = createField("STATE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.EventsTransactionsHistoryState.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsHistoryRecord, EventsTransactionsHistoryAccessMode> ACCESS_MODE = createField("ACCESS_MODE", org.jooq.impl.SQLDataType.VARCHAR(10).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.EventsTransactionsHistoryAccessMode.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsHistoryRecord, EventsTransactionsHistoryAutocommit> AUTOCOMMIT = createField("AUTOCOMMIT", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.EventsTransactionsHistoryAutocommit.class), this, "");
