...
public class PsIsAccountEnabled extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -671135907;
     ...
     */
    public static final Parameter<String> IN_HOST = createParameter("in_host", org.jooq.impl.SQLDataType.VARCHAR(255), false, false);
