...
public class SocketSummaryByInstance extends TableImpl<SocketSummaryByInstanceRecord> {
    ...
    private static final long serialVersionUID = 1421028425;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SOCKET_SUMMARY_BY_INSTANCE_EVENT_NAME, Indexes.SOCKET_SUMMARY_BY_INSTANCE_PRIMARY);
    }
