...
import com.syntax.sweagleapi.db.sys.tables.records.StatementsWithSortingRecord;
...
public class StatementsWithSorting extends TableImpl<StatementsWithSortingRecord> {
    ...
    private static final long serialVersionUID = -591917627;
     ...
     */
    public final TableField<StatementsWithSortingRecord, Timestamp> FIRST_SEEN = createField("first_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00.000000", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>sys.statements_with_sorting.last_seen</code>.
     */
    public final TableField<StatementsWithSortingRecord, Timestamp> LAST_SEEN = createField("last_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00.000000", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
