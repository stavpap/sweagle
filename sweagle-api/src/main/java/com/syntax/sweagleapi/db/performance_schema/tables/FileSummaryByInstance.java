...
public class FileSummaryByInstance extends TableImpl<FileSummaryByInstanceRecord> {
    ...
    private static final long serialVersionUID = -455637456;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.FILE_SUMMARY_BY_INSTANCE_EVENT_NAME, Indexes.FILE_SUMMARY_BY_INSTANCE_FILE_NAME, Indexes.FILE_SUMMARY_BY_INSTANCE_PRIMARY);
    }
