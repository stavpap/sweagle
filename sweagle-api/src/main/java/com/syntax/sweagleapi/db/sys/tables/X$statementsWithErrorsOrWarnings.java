...
import com.syntax.sweagleapi.db.sys.tables.records.X$statementsWithErrorsOrWarningsRecord;
...
public class X$statementsWithErrorsOrWarnings extends TableImpl<X$statementsWithErrorsOrWarningsRecord> {
    ...
    private static final long serialVersionUID = -371580929;
     ...
     */
    public final TableField<X$statementsWithErrorsOrWarningsRecord, Timestamp> FIRST_SEEN = createField("first_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00.000000", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>sys.x$statements_with_errors_or_warnings.last_seen</code>.
     */
    public final TableField<X$statementsWithErrorsOrWarningsRecord, Timestamp> LAST_SEEN = createField("last_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00.000000", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
