...
import com.syntax.sweagleapi.db.information_schema.enums.EventsIntervalField;
import com.syntax.sweagleapi.db.information_schema.enums.EventsStatus;
import com.syntax.sweagleapi.db.information_schema.tables.records.EventsRecord;
...
public class Events extends TableImpl<EventsRecord> {
    ...
    private static final long serialVersionUID = 689276256;
     ...
     */
    public final TableField<EventsRecord, String> EVENT_CATALOG = createField("EVENT_CATALOG", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.EVENTS.EVENT_SCHEMA</code>.
     */
    public final TableField<EventsRecord, String> EVENT_SCHEMA = createField("EVENT_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.EVENTS.EVENT_NAME</code>.
     */
    public final TableField<EventsRecord, String> EVENT_NAME = createField("EVENT_NAME", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.EVENTS.DEFINER</code>.
     */
    public final TableField<EventsRecord, String> DEFINER = createField("DEFINER", org.jooq.impl.SQLDataType.VARCHAR(288).nullable(false), this, "");

    /**
     * The column <code>information_schema.EVENTS.TIME_ZONE</code>.
     */
    public final TableField<EventsRecord, String> TIME_ZONE = createField("TIME_ZONE", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.EVENTS.EVENT_BODY</code>.
     */
    public final TableField<EventsRecord, String> EVENT_BODY = createField("EVENT_BODY", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<EventsRecord, EventsIntervalField> INTERVAL_FIELD = createField("INTERVAL_FIELD", org.jooq.impl.SQLDataType.VARCHAR(18).asEnumDataType(com.syntax.sweagleapi.db.information_schema.enums.EventsIntervalField.class), this, "");

    /**
     * The column <code>information_schema.EVENTS.SQL_MODE</code>.
     */
    public final TableField<EventsRecord, String> SQL_MODE = createField("SQL_MODE", org.jooq.impl.SQLDataType.VARCHAR(520).nullable(false), this, "");
     ...
     */
    public final TableField<EventsRecord, EventsStatus> STATUS = createField("STATUS", org.jooq.impl.SQLDataType.VARCHAR(18).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.information_schema.enums.EventsStatus.class), this, "");
     ...
     */
    public final TableField<EventsRecord, Timestamp> CREATED = createField("CREATED", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

    /**
     * The column <code>information_schema.EVENTS.LAST_ALTERED</code>.
     */
    public final TableField<EventsRecord, Timestamp> LAST_ALTERED = createField("LAST_ALTERED", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");
     ...
     */
    public final TableField<EventsRecord, String> EVENT_COMMENT = createField("EVENT_COMMENT", org.jooq.impl.SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>information_schema.EVENTS.ORIGINATOR</code>.
     */
    public final TableField<EventsRecord, UInteger> ORIGINATOR = createField("ORIGINATOR", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>information_schema.EVENTS.CHARACTER_SET_CLIENT</code>.
     */
    public final TableField<EventsRecord, String> CHARACTER_SET_CLIENT = createField("CHARACTER_SET_CLIENT", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.EVENTS.COLLATION_CONNECTION</code>.
     */
    public final TableField<EventsRecord, String> COLLATION_CONNECTION = createField("COLLATION_CONNECTION", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.EVENTS.DATABASE_COLLATION</code>.
     */
    public final TableField<EventsRecord, String> DATABASE_COLLATION = createField("DATABASE_COLLATION", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
