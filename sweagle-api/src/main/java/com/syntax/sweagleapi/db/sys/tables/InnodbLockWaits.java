...
import com.syntax.sweagleapi.db.sys.tables.records.InnodbLockWaitsRecord;
...
public class InnodbLockWaits extends TableImpl<InnodbLockWaitsRecord> {
    ...
    private static final long serialVersionUID = -64554483;
     ...
     */
    public final TableField<InnodbLockWaitsRecord, String> SQL_KILL_BLOCKING_QUERY = createField("sql_kill_blocking_query", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.innodb_lock_waits.sql_kill_blocking_connection</code>.
     */
    public final TableField<InnodbLockWaitsRecord, String> SQL_KILL_BLOCKING_CONNECTION = createField("sql_kill_blocking_connection", org.jooq.impl.SQLDataType.VARCHAR(26).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
