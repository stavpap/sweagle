...
import com.syntax.sweagleapi.db.information_schema.tables.records.CheckConstraintsRecord;
...
public class CheckConstraints extends TableImpl<CheckConstraintsRecord> {
    ...
    private static final long serialVersionUID = 1609051817;
     ...
     */
    public final TableField<CheckConstraintsRecord, String> CONSTRAINT_CATALOG = createField("CONSTRAINT_CATALOG", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.CHECK_CONSTRAINTS.CONSTRAINT_SCHEMA</code>.
     */
    public final TableField<CheckConstraintsRecord, String> CONSTRAINT_SCHEMA = createField("CONSTRAINT_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
