...
import com.syntax.sweagleapi.db.information_schema.enums.CollationsPadAttribute;
import com.syntax.sweagleapi.db.information_schema.tables.records.CollationsRecord;
...
public class Collations extends TableImpl<CollationsRecord> {
    ...
    private static final long serialVersionUID = 1982409910;
     ...
     */
    public final TableField<CollationsRecord, CollationsPadAttribute> PAD_ATTRIBUTE = createField("PAD_ATTRIBUTE", org.jooq.impl.SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.information_schema.enums.CollationsPadAttribute.class), this, "");
