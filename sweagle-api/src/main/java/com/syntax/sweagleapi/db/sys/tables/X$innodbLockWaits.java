...
import com.syntax.sweagleapi.db.sys.tables.records.X$innodbLockWaitsRecord;
...
public class X$innodbLockWaits extends TableImpl<X$innodbLockWaitsRecord> {
    ...
    private static final long serialVersionUID = -1961025959;
     ...
     */
    public final TableField<X$innodbLockWaitsRecord, String> LOCKED_TABLE = createField("locked_table", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>sys.x$innodb_lock_waits.locked_table_schema</code>.
     */
    public final TableField<X$innodbLockWaitsRecord, String> LOCKED_TABLE_SCHEMA = createField("locked_table_schema", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>sys.x$innodb_lock_waits.locked_table_name</code>.
     */
    public final TableField<X$innodbLockWaitsRecord, String> LOCKED_TABLE_NAME = createField("locked_table_name", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>sys.x$innodb_lock_waits.locked_table_partition</code>.
     */
    public final TableField<X$innodbLockWaitsRecord, String> LOCKED_TABLE_PARTITION = createField("locked_table_partition", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>sys.x$innodb_lock_waits.locked_table_subpartition</code>.
     */
    public final TableField<X$innodbLockWaitsRecord, String> LOCKED_TABLE_SUBPARTITION = createField("locked_table_subpartition", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>sys.x$innodb_lock_waits.locked_index</code>.
     */
    public final TableField<X$innodbLockWaitsRecord, String> LOCKED_INDEX = createField("locked_index", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>sys.x$innodb_lock_waits.locked_type</code>.
     */
    public final TableField<X$innodbLockWaitsRecord, String> LOCKED_TYPE = createField("locked_type", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false), this, "");
     ...
     */
    public final TableField<X$innodbLockWaitsRecord, String> WAITING_LOCK_ID = createField("waiting_lock_id", org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "");

    /**
     * The column <code>sys.x$innodb_lock_waits.waiting_lock_mode</code>.
     */
    public final TableField<X$innodbLockWaitsRecord, String> WAITING_LOCK_MODE = createField("waiting_lock_mode", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false), this, "");
     ...
     */
    public final TableField<X$innodbLockWaitsRecord, String> BLOCKING_LOCK_ID = createField("blocking_lock_id", org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "");

    /**
     * The column <code>sys.x$innodb_lock_waits.blocking_lock_mode</code>.
     */
    public final TableField<X$innodbLockWaitsRecord, String> BLOCKING_LOCK_MODE = createField("blocking_lock_mode", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false), this, "");
     ...
     */
    public final TableField<X$innodbLockWaitsRecord, String> SQL_KILL_BLOCKING_QUERY = createField("sql_kill_blocking_query", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.x$innodb_lock_waits.sql_kill_blocking_connection</code>.
     */
    public final TableField<X$innodbLockWaitsRecord, String> SQL_KILL_BLOCKING_CONNECTION = createField("sql_kill_blocking_connection", org.jooq.impl.SQLDataType.VARCHAR(26).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
