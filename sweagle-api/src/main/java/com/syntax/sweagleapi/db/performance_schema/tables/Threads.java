...
import com.syntax.sweagleapi.db.performance_schema.enums.ThreadsHistory;
import com.syntax.sweagleapi.db.performance_schema.enums.ThreadsInstrumented;
...
public class Threads extends TableImpl<ThreadsRecord> {
    ...
    private static final long serialVersionUID = 1545821309;
     ...
     */
    public final TableField<ThreadsRecord, ThreadsInstrumented> INSTRUMENTED = createField("INSTRUMENTED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.ThreadsInstrumented.class), this, "");

    /**
     * The column <code>performance_schema.threads.HISTORY</code>.
     */
    public final TableField<ThreadsRecord, ThreadsHistory> HISTORY = createField("HISTORY", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.ThreadsHistory.class), this, "");
