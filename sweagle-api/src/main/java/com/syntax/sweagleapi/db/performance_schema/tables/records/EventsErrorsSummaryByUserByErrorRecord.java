...
public class EventsErrorsSummaryByUserByErrorRecord extends TableRecordImpl<EventsErrorsSummaryByUserByErrorRecord> implements Record8<String, Integer, String, String, ULong, ULong, Timestamp, Timestamp> {

    private static final long serialVersionUID = 964585422;
     ...
     */
    @Override
    public EventsErrorsSummaryByUserByErrorRecord value7(Timestamp value) {
        setFirstSeen(value);
        return this;
    }
     ...
     */
    @Override
    public EventsErrorsSummaryByUserByErrorRecord value8(Timestamp value) {
        setLastSeen(value);
        return this;
    }
     ...
     */
    @Override
    public EventsErrorsSummaryByUserByErrorRecord values(String value1, Integer value2, String value3, String value4, ULong value5, ULong value6, Timestamp value7, Timestamp value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EventsErrorsSummaryByUserByErrorRecord(String user, Integer errorNumber, String errorName, String sqlState, ULong sumErrorRaised, ULong sumErrorHandled, Timestamp firstSeen, Timestamp lastSeen) {
        super(EventsErrorsSummaryByUserByError.EVENTS_ERRORS_SUMMARY_BY_USER_BY_ERROR);
