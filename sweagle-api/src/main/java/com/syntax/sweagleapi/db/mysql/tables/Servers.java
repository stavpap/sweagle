...
public class Servers extends TableImpl<ServersRecord> {
    ...
    private static final long serialVersionUID = 8695492;
     ...
     */
    public final TableField<ServersRecord, String> HOST = createField("Host", org.jooq.impl.SQLDataType.CHAR(255).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
