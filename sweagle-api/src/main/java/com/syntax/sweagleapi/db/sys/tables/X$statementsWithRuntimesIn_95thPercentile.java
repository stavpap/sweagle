...
import com.syntax.sweagleapi.db.sys.tables.records.X$statementsWithRuntimesIn_95thPercentileRecord;
...
public class X$statementsWithRuntimesIn_95thPercentile extends TableImpl<X$statementsWithRuntimesIn_95thPercentileRecord> {
    ...
    private static final long serialVersionUID = -1996680610;
     ...
     */
    public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, Timestamp> FIRST_SEEN = createField("first_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00.000000", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>sys.x$statements_with_runtimes_in_95th_percentile.last_seen</code>.
     */
    public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, Timestamp> LAST_SEEN = createField("last_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00.000000", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>sys.x$statements_with_runtimes_in_95th_percentile.digest</code>.
     */
    public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, String> DIGEST = createField("digest", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
