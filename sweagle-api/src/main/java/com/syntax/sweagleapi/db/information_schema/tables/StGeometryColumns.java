...
import com.syntax.sweagleapi.db.information_schema.tables.records.StGeometryColumnsRecord;
...
public class StGeometryColumns extends TableImpl<StGeometryColumnsRecord> {
    ...
    private static final long serialVersionUID = 1426060967;
     ...
     */
    public final TableField<StGeometryColumnsRecord, String> TABLE_CATALOG = createField("TABLE_CATALOG", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.ST_GEOMETRY_COLUMNS.TABLE_SCHEMA</code>.
     */
    public final TableField<StGeometryColumnsRecord, String> TABLE_SCHEMA = createField("TABLE_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.ST_GEOMETRY_COLUMNS.TABLE_NAME</code>.
     */
    public final TableField<StGeometryColumnsRecord, String> TABLE_NAME = createField("TABLE_NAME", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
