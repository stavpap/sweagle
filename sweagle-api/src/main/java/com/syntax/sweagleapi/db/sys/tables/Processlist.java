...
import com.syntax.sweagleapi.db.sys.enums.ProcesslistTrxAutocommit;
import com.syntax.sweagleapi.db.sys.enums.ProcesslistTrxState;
import com.syntax.sweagleapi.db.sys.tables.records.ProcesslistRecord;
...
public class Processlist extends TableImpl<ProcesslistRecord> {
    ...
    private static final long serialVersionUID = 1504021544;
     ...
     */
    public final TableField<ProcesslistRecord, ProcesslistTrxState> TRX_STATE = createField("trx_state", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.syntax.sweagleapi.db.sys.enums.ProcesslistTrxState.class), this, "");

    /**
     * The column <code>sys.processlist.trx_autocommit</code>.
     */
    public final TableField<ProcesslistRecord, ProcesslistTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.impl.SQLDataType.VARCHAR(3).asEnumDataType(com.syntax.sweagleapi.db.sys.enums.ProcesslistTrxAutocommit.class), this, "");
