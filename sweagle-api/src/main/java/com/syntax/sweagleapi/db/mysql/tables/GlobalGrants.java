...
import com.syntax.sweagleapi.db.mysql.enums.GlobalGrantsWithGrantOption;
...
public class GlobalGrants extends TableImpl<GlobalGrantsRecord> {
    ...
    private static final long serialVersionUID = -27106387;
    ...
    private GlobalGrants(Name alias, Table<GlobalGrantsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Extended global grants"));
    }
