...
import com.syntax.sweagleapi.db.information_schema.tables.records.ViewTableUsageRecord;
...
public class ViewTableUsage extends TableImpl<ViewTableUsageRecord> {
    ...
    private static final long serialVersionUID = -322614870;
     ...
     */
    public final TableField<ViewTableUsageRecord, String> VIEW_CATALOG = createField("VIEW_CATALOG", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.VIEW_TABLE_USAGE.VIEW_SCHEMA</code>.
     */
    public final TableField<ViewTableUsageRecord, String> VIEW_SCHEMA = createField("VIEW_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.VIEW_TABLE_USAGE.VIEW_NAME</code>.
     */
    public final TableField<ViewTableUsageRecord, String> VIEW_NAME = createField("VIEW_NAME", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.VIEW_TABLE_USAGE.TABLE_CATALOG</code>.
     */
    public final TableField<ViewTableUsageRecord, String> TABLE_CATALOG = createField("TABLE_CATALOG", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.VIEW_TABLE_USAGE.TABLE_SCHEMA</code>.
     */
    public final TableField<ViewTableUsageRecord, String> TABLE_SCHEMA = createField("TABLE_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.VIEW_TABLE_USAGE.TABLE_NAME</code>.
     */
    public final TableField<ViewTableUsageRecord, String> TABLE_NAME = createField("TABLE_NAME", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
