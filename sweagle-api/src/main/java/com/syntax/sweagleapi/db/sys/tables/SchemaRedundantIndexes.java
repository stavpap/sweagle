...
import com.syntax.sweagleapi.db.sys.tables.records.SchemaRedundantIndexesRecord;
...
public class SchemaRedundantIndexes extends TableImpl<SchemaRedundantIndexesRecord> {
    ...
    private static final long serialVersionUID = 1844844603;
     ...
     */
    public final TableField<SchemaRedundantIndexesRecord, String> TABLE_SCHEMA = createField("table_schema", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>sys.schema_redundant_indexes.table_name</code>.
     */
    public final TableField<SchemaRedundantIndexesRecord, String> TABLE_NAME = createField("table_name", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
