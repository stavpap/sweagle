...
import com.syntax.sweagleapi.db.performance_schema.enums.HostCacheHostValidated;
...
public class HostCache extends TableImpl<HostCacheRecord> {
    ...
    private static final long serialVersionUID = 4054715;
     ...
     */
    public final TableField<HostCacheRecord, HostCacheHostValidated> HOST_VALIDATED = createField("HOST_VALIDATED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.HostCacheHostValidated.class), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.HOST_CACHE_HOST, Indexes.HOST_CACHE_PRIMARY);
    }
