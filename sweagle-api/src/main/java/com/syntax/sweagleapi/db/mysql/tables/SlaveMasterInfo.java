...
public class SlaveMasterInfo extends TableImpl<SlaveMasterInfoRecord> {
    ...
    private static final long serialVersionUID = -2085101098;
     ...
     */
    public final TableField<SlaveMasterInfoRecord, String> HOST = createField("Host", org.jooq.impl.SQLDataType.CHAR(255), this, "The host name of the master.");
     ...
     */
    public final TableField<SlaveMasterInfoRecord, String> MASTER_COMPRESSION_ALGORITHM = createField("Master_compression_algorithm", org.jooq.impl.SQLDataType.CHAR(64).nullable(false), this, "Compression algorithm supported for data transfer between master and slave.");
