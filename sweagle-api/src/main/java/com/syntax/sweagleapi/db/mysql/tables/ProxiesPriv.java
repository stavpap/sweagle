...
public class ProxiesPriv extends TableImpl<ProxiesPrivRecord> {
    ...
    private static final long serialVersionUID = -784789123;
     ...
     */
    public final TableField<ProxiesPrivRecord, String> HOST = createField("Host", org.jooq.impl.SQLDataType.CHAR(255).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
     ...
     */
    public final TableField<ProxiesPrivRecord, String> PROXIED_HOST = createField("Proxied_host", org.jooq.impl.SQLDataType.CHAR(255).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
     ...
     */
    public final TableField<ProxiesPrivRecord, String> GRANTOR = createField("Grantor", org.jooq.impl.SQLDataType.VARCHAR(288).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
