...
import com.syntax.sweagleapi.db.sys.tables.records.SchemaObjectOverviewRecord;
...
public class SchemaObjectOverview extends TableImpl<SchemaObjectOverviewRecord> {
    ...
    private static final long serialVersionUID = -924778966;
     ...
     */
    public final TableField<SchemaObjectOverviewRecord, String> DB = createField("db", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
