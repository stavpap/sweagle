...
import com.syntax.sweagleapi.db.mysql.enums.RoleEdgesWithAdminOption;
...
public class RoleEdges extends TableImpl<RoleEdgesRecord> {
    ...
    private static final long serialVersionUID = -1227646861;
    ...
    private RoleEdges(Name alias, Table<RoleEdgesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Role hierarchy and role grants"));
    }
