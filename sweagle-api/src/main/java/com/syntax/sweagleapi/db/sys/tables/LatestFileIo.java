...
import com.syntax.sweagleapi.db.sys.tables.records.LatestFileIoRecord;
...
public class LatestFileIo extends TableImpl<LatestFileIoRecord> {
    ...
    private static final long serialVersionUID = -1999820516;
     ...
     */
    public final TableField<LatestFileIoRecord, String> THREAD = createField("thread", org.jooq.impl.SQLDataType.VARCHAR(316), this, "");
