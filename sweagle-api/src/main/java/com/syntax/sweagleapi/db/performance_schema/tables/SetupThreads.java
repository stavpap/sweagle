...
import com.syntax.sweagleapi.db.performance_schema.enums.SetupThreadsEnabled;
import com.syntax.sweagleapi.db.performance_schema.enums.SetupThreadsHistory;
...
public class SetupThreads extends TableImpl<SetupThreadsRecord> {
    ...
    private static final long serialVersionUID = -1685391939;
     ...
     */
    public final TableField<SetupThreadsRecord, SetupThreadsEnabled> ENABLED = createField("ENABLED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.SetupThreadsEnabled.class), this, "");

    /**
     * The column <code>performance_schema.setup_threads.HISTORY</code>.
     */
    public final TableField<SetupThreadsRecord, SetupThreadsHistory> HISTORY = createField("HISTORY", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.SetupThreadsHistory.class), this, "");
