...
import com.syntax.sweagleapi.db.performance_schema.enums.SocketInstancesState;
...
public class SocketInstances extends TableImpl<SocketInstancesRecord> {
    ...
    private static final long serialVersionUID = -494627234;
     ...
     */
    public final TableField<SocketInstancesRecord, SocketInstancesState> STATE = createField("STATE", org.jooq.impl.SQLDataType.VARCHAR(6).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.SocketInstancesState.class), this, "");
