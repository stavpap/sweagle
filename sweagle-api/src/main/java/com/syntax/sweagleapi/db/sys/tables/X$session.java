...
import com.syntax.sweagleapi.db.sys.enums.X$sessionTrxAutocommit;
import com.syntax.sweagleapi.db.sys.enums.X$sessionTrxState;
import com.syntax.sweagleapi.db.sys.tables.records.X$sessionRecord;
...
public class X$session extends TableImpl<X$sessionRecord> {
    ...
    private static final long serialVersionUID = -1510151116;
     ...
     */
    public final TableField<X$sessionRecord, X$sessionTrxState> TRX_STATE = createField("trx_state", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.syntax.sweagleapi.db.sys.enums.X$sessionTrxState.class), this, "");

    /**
     * The column <code>sys.x$session.trx_autocommit</code>.
     */
    public final TableField<X$sessionRecord, X$sessionTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.impl.SQLDataType.VARCHAR(3).asEnumDataType(com.syntax.sweagleapi.db.sys.enums.X$sessionTrxAutocommit.class), this, "");
