...
import com.syntax.sweagleapi.db.sys.tables.records.IoByThreadByLatencyRecord;
...
public class IoByThreadByLatency extends TableImpl<IoByThreadByLatencyRecord> {
    ...
    private static final long serialVersionUID = 1794765160;
     ...
     */
    public final TableField<IoByThreadByLatencyRecord, String> USER = createField("user", org.jooq.impl.SQLDataType.VARCHAR(288), this, "");
