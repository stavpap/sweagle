...
import com.syntax.sweagleapi.db.performance_schema.enums.EventsStatementsHistoryNestingEventType;
...
public class EventsStatementsHistory extends TableImpl<EventsStatementsHistoryRecord> {
    ...
    private static final long serialVersionUID = 883833531;
     ...
     */
    public final TableField<EventsStatementsHistoryRecord, String> DIGEST = createField("DIGEST", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<EventsStatementsHistoryRecord, EventsStatementsHistoryNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.EventsStatementsHistoryNestingEventType.class), this, "");
     ...
     */
    public final TableField<EventsStatementsHistoryRecord, ULong> STATEMENT_ID = createField("STATEMENT_ID", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.EVENTS_STATEMENTS_HISTORY_PRIMARY);
    }
