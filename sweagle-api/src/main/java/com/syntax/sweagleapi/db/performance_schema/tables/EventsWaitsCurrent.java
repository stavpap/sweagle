...
import com.syntax.sweagleapi.db.performance_schema.enums.EventsWaitsCurrentNestingEventType;
...
public class EventsWaitsCurrent extends TableImpl<EventsWaitsCurrentRecord> {
    ...
    private static final long serialVersionUID = 1962027128;
     ...
     */
    public final TableField<EventsWaitsCurrentRecord, EventsWaitsCurrentNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.EventsWaitsCurrentNestingEventType.class), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.EVENTS_WAITS_CURRENT_PRIMARY);
    }
