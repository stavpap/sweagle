...
import com.syntax.sweagleapi.db.information_schema.enums.ReferentialConstraintsDeleteRule;
import com.syntax.sweagleapi.db.information_schema.enums.ReferentialConstraintsMatchOption;
import com.syntax.sweagleapi.db.information_schema.enums.ReferentialConstraintsUpdateRule;
import com.syntax.sweagleapi.db.information_schema.tables.records.ReferentialConstraintsRecord;
...
public class ReferentialConstraints extends TableImpl<ReferentialConstraintsRecord> {
    ...
    private static final long serialVersionUID = 104825968;
     ...
     */
    public final TableField<ReferentialConstraintsRecord, String> CONSTRAINT_CATALOG = createField("CONSTRAINT_CATALOG", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.REFERENTIAL_CONSTRAINTS.CONSTRAINT_SCHEMA</code>.
     */
    public final TableField<ReferentialConstraintsRecord, String> CONSTRAINT_SCHEMA = createField("CONSTRAINT_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.REFERENTIAL_CONSTRAINTS.CONSTRAINT_NAME</code>.
     */
    public final TableField<ReferentialConstraintsRecord, String> CONSTRAINT_NAME = createField("CONSTRAINT_NAME", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.REFERENTIAL_CONSTRAINTS.UNIQUE_CONSTRAINT_CATALOG</code>.
     */
    public final TableField<ReferentialConstraintsRecord, String> UNIQUE_CONSTRAINT_CATALOG = createField("UNIQUE_CONSTRAINT_CATALOG", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.REFERENTIAL_CONSTRAINTS.UNIQUE_CONSTRAINT_SCHEMA</code>.
     */
    public final TableField<ReferentialConstraintsRecord, String> UNIQUE_CONSTRAINT_SCHEMA = createField("UNIQUE_CONSTRAINT_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
     ...
     */
    public final TableField<ReferentialConstraintsRecord, ReferentialConstraintsMatchOption> MATCH_OPTION = createField("MATCH_OPTION", org.jooq.impl.SQLDataType.VARCHAR(7).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.information_schema.enums.ReferentialConstraintsMatchOption.class), this, "");

    /**
     * The column <code>information_schema.REFERENTIAL_CONSTRAINTS.UPDATE_RULE</code>.
     */
    public final TableField<ReferentialConstraintsRecord, ReferentialConstraintsUpdateRule> UPDATE_RULE = createField("UPDATE_RULE", org.jooq.impl.SQLDataType.VARCHAR(11).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.information_schema.enums.ReferentialConstraintsUpdateRule.class), this, "");

    /**
     * The column <code>information_schema.REFERENTIAL_CONSTRAINTS.DELETE_RULE</code>.
     */
    public final TableField<ReferentialConstraintsRecord, ReferentialConstraintsDeleteRule> DELETE_RULE = createField("DELETE_RULE", org.jooq.impl.SQLDataType.VARCHAR(11).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.information_schema.enums.ReferentialConstraintsDeleteRule.class), this, "");

    /**
     * The column <code>information_schema.REFERENTIAL_CONSTRAINTS.TABLE_NAME</code>.
     */
    public final TableField<ReferentialConstraintsRecord, String> TABLE_NAME = createField("TABLE_NAME", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.REFERENTIAL_CONSTRAINTS.REFERENCED_TABLE_NAME</code>.
     */
    public final TableField<ReferentialConstraintsRecord, String> REFERENCED_TABLE_NAME = createField("REFERENCED_TABLE_NAME", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
