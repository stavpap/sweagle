...
import com.syntax.sweagleapi.db.information_schema.tables.records.PartitionsRecord;
...
public class Partitions extends TableImpl<PartitionsRecord> {
    ...
    private static final long serialVersionUID = -802900583;
     ...
     */
    public final TableField<PartitionsRecord, String> TABLE_CATALOG = createField("TABLE_CATALOG", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.TABLE_SCHEMA</code>.
     */
    public final TableField<PartitionsRecord, String> TABLE_SCHEMA = createField("TABLE_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.TABLE_NAME</code>.
     */
    public final TableField<PartitionsRecord, String> TABLE_NAME = createField("TABLE_NAME", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
     ...
     */
    public final TableField<PartitionsRecord, UInteger> PARTITION_ORDINAL_POSITION = createField("PARTITION_ORDINAL_POSITION", org.jooq.impl.SQLDataType.INTEGERUNSIGNED, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.SUBPARTITION_ORDINAL_POSITION</code>.
     */
    public final TableField<PartitionsRecord, UInteger> SUBPARTITION_ORDINAL_POSITION = createField("SUBPARTITION_ORDINAL_POSITION", org.jooq.impl.SQLDataType.INTEGERUNSIGNED, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.PARTITION_METHOD</code>.
     */
    public final TableField<PartitionsRecord, String> PARTITION_METHOD = createField("PARTITION_METHOD", org.jooq.impl.SQLDataType.VARCHAR(13), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.SUBPARTITION_METHOD</code>.
     */
    public final TableField<PartitionsRecord, String> SUBPARTITION_METHOD = createField("SUBPARTITION_METHOD", org.jooq.impl.SQLDataType.VARCHAR(13), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.PARTITION_EXPRESSION</code>.
     */
    public final TableField<PartitionsRecord, String> PARTITION_EXPRESSION = createField("PARTITION_EXPRESSION", org.jooq.impl.SQLDataType.VARCHAR(2048), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.SUBPARTITION_EXPRESSION</code>.
     */
    public final TableField<PartitionsRecord, String> SUBPARTITION_EXPRESSION = createField("SUBPARTITION_EXPRESSION", org.jooq.impl.SQLDataType.VARCHAR(2048), this, "");
     ...
     */
    public final TableField<PartitionsRecord, ULong> TABLE_ROWS = createField("TABLE_ROWS", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.AVG_ROW_LENGTH</code>.
     */
    public final TableField<PartitionsRecord, ULong> AVG_ROW_LENGTH = createField("AVG_ROW_LENGTH", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.DATA_LENGTH</code>.
     */
    public final TableField<PartitionsRecord, ULong> DATA_LENGTH = createField("DATA_LENGTH", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "");
     ...
     */
    public final TableField<PartitionsRecord, ULong> INDEX_LENGTH = createField("INDEX_LENGTH", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.DATA_FREE</code>.
     */
    public final TableField<PartitionsRecord, ULong> DATA_FREE = createField("DATA_FREE", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.CREATE_TIME</code>.
     */
    public final TableField<PartitionsRecord, Timestamp> CREATE_TIME = createField("CREATE_TIME", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");
     ...
     */
    public final TableField<PartitionsRecord, Long> CHECKSUM = createField("CHECKSUM", org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.PARTITION_COMMENT</code>.
     */
    public final TableField<PartitionsRecord, String> PARTITION_COMMENT = createField("PARTITION_COMMENT", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.NODEGROUP</code>.
     */
    public final TableField<PartitionsRecord, String> NODEGROUP = createField("NODEGROUP", org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.TABLESPACE_NAME</code>.
     */
    public final TableField<PartitionsRecord, String> TABLESPACE_NAME = createField("TABLESPACE_NAME", org.jooq.impl.SQLDataType.VARCHAR(268), this, "");
