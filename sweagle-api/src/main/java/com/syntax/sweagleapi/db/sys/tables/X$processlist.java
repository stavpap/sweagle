...
import com.syntax.sweagleapi.db.sys.enums.X$processlistTrxAutocommit;
import com.syntax.sweagleapi.db.sys.enums.X$processlistTrxState;
import com.syntax.sweagleapi.db.sys.tables.records.X$processlistRecord;
...
public class X$processlist extends TableImpl<X$processlistRecord> {
    ...
    private static final long serialVersionUID = 994595675;
     ...
     */
    public final TableField<X$processlistRecord, X$processlistTrxState> TRX_STATE = createField("trx_state", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.syntax.sweagleapi.db.sys.enums.X$processlistTrxState.class), this, "");

    /**
     * The column <code>sys.x$processlist.trx_autocommit</code>.
     */
    public final TableField<X$processlistRecord, X$processlistTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.impl.SQLDataType.VARCHAR(3).asEnumDataType(com.syntax.sweagleapi.db.sys.enums.X$processlistTrxAutocommit.class), this, "");
