...
import com.syntax.sweagleapi.db.sys.tables.records.X$latestFileIoRecord;
...
public class X$latestFileIo extends TableImpl<X$latestFileIoRecord> {
    ...
    private static final long serialVersionUID = 1680343855;
     ...
     */
    public final TableField<X$latestFileIoRecord, String> THREAD = createField("thread", org.jooq.impl.SQLDataType.VARCHAR(316), this, "");
