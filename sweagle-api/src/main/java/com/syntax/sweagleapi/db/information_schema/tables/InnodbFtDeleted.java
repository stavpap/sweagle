...
import com.syntax.sweagleapi.db.information_schema.tables.records.InnodbFtDeletedRecord;
...
public class InnodbFtDeleted extends TableImpl<InnodbFtDeletedRecord> {
    ...
    private static final long serialVersionUID = -2013562579;
     ...
     */
    public final TableField<InnodbFtDeletedRecord, ULong> DOC_ID = createField("DOC_ID", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.BIGINTUNSIGNED)), this, "");
