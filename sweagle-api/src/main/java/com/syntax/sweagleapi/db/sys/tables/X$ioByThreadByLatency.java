...
import com.syntax.sweagleapi.db.sys.tables.records.X$ioByThreadByLatencyRecord;
...
public class X$ioByThreadByLatency extends TableImpl<X$ioByThreadByLatencyRecord> {
    ...
    private static final long serialVersionUID = 1117786387;
     ...
     */
    public final TableField<X$ioByThreadByLatencyRecord, String> USER = createField("user", org.jooq.impl.SQLDataType.VARCHAR(288), this, "");
