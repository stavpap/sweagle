...
import com.syntax.sweagleapi.db.sys.tables.records.StatementAnalysisRecord;
...
public class StatementAnalysis extends TableImpl<StatementAnalysisRecord> {
    ...
    private static final long serialVersionUID = -704908802;
     ...
     */
    public final TableField<StatementAnalysisRecord, Timestamp> FIRST_SEEN = createField("first_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00.000000", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>sys.statement_analysis.last_seen</code>.
     */
    public final TableField<StatementAnalysisRecord, Timestamp> LAST_SEEN = createField("last_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00.000000", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
