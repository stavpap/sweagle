...
import com.syntax.sweagleapi.db.information_schema.tables.records.InnodbFtDefaultStopwordRecord;
...
public class InnodbFtDefaultStopword extends TableImpl<InnodbFtDefaultStopwordRecord> {
    ...
    private static final long serialVersionUID = 1077716034;
     ...
     */
    public final TableField<InnodbFtDefaultStopwordRecord, String> VALUE = createField("value", org.jooq.impl.SQLDataType.VARCHAR(6).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
