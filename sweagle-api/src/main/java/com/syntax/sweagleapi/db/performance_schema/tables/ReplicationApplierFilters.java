...
import com.syntax.sweagleapi.db.performance_schema.enums.ReplicationApplierFiltersConfiguredBy;
import com.syntax.sweagleapi.db.performance_schema.tables.records.ReplicationApplierFiltersRecord;
...
public class ReplicationApplierFilters extends TableImpl<ReplicationApplierFiltersRecord> {
    ...
    private static final long serialVersionUID = 587365426;
     ...
     */
    public final TableField<ReplicationApplierFiltersRecord, ReplicationApplierFiltersConfiguredBy> CONFIGURED_BY = createField("CONFIGURED_BY", org.jooq.impl.SQLDataType.VARCHAR(37).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.performance_schema.enums.ReplicationApplierFiltersConfiguredBy.class), this, "");

    /**
     * The column <code>performance_schema.replication_applier_filters.ACTIVE_SINCE</code>.
     */
    public final TableField<ReplicationApplierFiltersRecord, Timestamp> ACTIVE_SINCE = createField("ACTIVE_SINCE", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00.000000", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
