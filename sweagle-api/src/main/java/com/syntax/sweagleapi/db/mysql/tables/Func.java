...
import com.syntax.sweagleapi.db.mysql.enums.FuncType;
...
public class Func extends TableImpl<FuncRecord> {
    ...
    private static final long serialVersionUID = 1100907313;
     ...
     */
    public final TableField<FuncRecord, FuncType> TYPE = createField("type", org.jooq.impl.SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(com.syntax.sweagleapi.db.mysql.enums.FuncType.class), this, "");
